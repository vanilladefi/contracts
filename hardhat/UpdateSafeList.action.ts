...
const initialSafeList = (network: Network) => {
  switch (network.config.chainId) {
    case 1:
      return safeListV1_02.map((pool) => pool.address)
    case 4:
      return ["0xdc588526bbfd072d0c632a92b25419e59267d0ab"]
    default:
      return []
  }
}
...
export default async (
  ...
  let vanillaV1Safelist01 = VanillaV1Safelist01__factory.connect(
    safelist,
    signer,
  )
